...
#**** Frequency of each categories, Manually analyze all Unique type of all 
# Categories, then found out that JobType and occupation has special char
# as " ?" for missing values. Thats why isnull().sum() was showing Zeros in all
